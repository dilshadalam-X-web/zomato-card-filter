...
function getResturant(resturants){
    ...
    resturants.forEach(resturant=>{
        ...
        //image 
        //card content
        //1. card_header(Name,Rating)
        //2.card_footer(food_type, and price)
        //3.card_location(Resturant_location,distance)
        ...
        //card footer
           ...
           food.textContent=resturant.food_type;

            const price=document.createElement('span');
           price.textContent="₹"+resturant.price_for_two;
          ...
          //card location
           ...
           card_location.classList.add('card-location');
            ...
            distance.textContent=resturant.distance_from_Customer_house+" km";
...
document.getElementById("Open").addEventListener('click', () => {
    ...
    const result = resturants.filter((obj) => {
        ...
        if (obj.restaurant_open_time < obj.restaurant_close_time) {
            return currentHour >= obj.restaurant_open_time && currentHour < obj.restaurant_close_time;
        } else {
            // Late night case (jaise 16 se 4 tak)
            return currentHour >= obj.restaurant_open_time || currentHour < obj.restaurant_close_time;
        }
...
document.getElementById('applyFilter').addEventListener('click',()=>{
   ...
   if(answer==="rating"){
    ...
    resturants.sort((a,b)=>b.price_for_two-a.price_for_two);

   }
   else if(answer==="costLowHigh"){
    resturants.sort((a,b)=>a.price_for_two-b.price_for_two);
   }
   else if(answer==="distance"){
    resturants.sort((a,b)=>a.distance_from_Customer_house-b.distance_from_Customer_house);
